...
- Hit the run button while you have a prompt file open in VS Code`,
	...
	agentsSection: `## 🤖 Autonomous Agents

Specialized agents that provide autonomous capabilities for complex workflows, code reviews, and specialized development tasks.`,

	agentsUsage: `### How to Use Agents

**To Install:**
- Click the **VS Code** or **VS Code Insiders** install button for the agent you want to use
- Download the \`*.agent.md\` file and manually install it in VS Code using the Command Palette

**To Activate/Use:**
- Import the agent configuration into your VS Code settings
- Access the installed agents through the VS Code Chat interface
- Select the desired agent from the available options in VS Code Chat`,
};
...
function generateAgentsSection(agentsDir) {
	...
	// Create table header
	let agentsContent = "| Title | Description |\n| ----- | ----------- |\n";
	...
	for (const file of agentFiles) {
		...
		if (customDescription && customDescription !== "null") {
			agentsContent += `| [${title}](${link})<br />${badges} | ${customDescription} |\n`;
		} else {
			agentsContent += `| [${title}](${link})<br />${badges} | | |\n`;
		}
	}
