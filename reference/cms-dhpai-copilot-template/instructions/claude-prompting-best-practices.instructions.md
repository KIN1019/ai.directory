---
description: Prompting best practices for Claude 4.x models
applyTo: ".github/instructions/*.instructions.md,.github/prompts/*.prompt.md,.github/agents/*.agent.md,.github/copilot-instructions.md,**/AGENTS.md,**/CLAUDE.md,**/GEMINI.md"
---
