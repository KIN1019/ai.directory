-- hkpmi.hkpmi_ward definition

-- Drop table

-- DROP TABLE hkpmi.hkpmi_ward;

CREATE TABLE hkpmi.hkpmi_ward (
...
CREATE UNIQUE INDEX hkpmi_ward_index ON hkpmi.hkpmi_ward USING btree (hospital_code, ward_code, effective_date);




ALTER TABLE hkpmi.hkpmi_ward OWNER TO "HKPMI_SCHEMA_OWNER_ROLE";
