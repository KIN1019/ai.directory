-- hkpmi.patient definition

-- Drop table

-- DROP TABLE hkpmi.patient;

CREATE TABLE hkpmi.patient (
...
CREATE UNIQUE INDEX "XAK1patient" ON hkpmi.patient USING btree (hkid);
CREATE INDEX "XIE1patient" ON hkpmi.patient USING btree (patient_name, sex, dob);
CREATE INDEX "XIE2patient" ON hkpmi.patient USING btree (chi_name, sex, dob);
CREATE INDEX "XIE3patient" ON hkpmi.patient USING btree (other_doc_no);
CREATE UNIQUE INDEX "XPKpatient" ON hkpmi.patient USING btree (patient_key);



ALTER TABLE hkpmi.patient OWNER TO "HKPMI_SCHEMA_OWNER_ROLE";
