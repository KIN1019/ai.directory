-- hkpmi.patient_history definition

-- Drop table

-- DROP TABLE hkpmi.patient_history;

CREATE TABLE hkpmi.patient_history (
...
CREATE UNIQUE INDEX "XIE1patient_history" ON hkpmi.patient_history USING btree (patient_key, system_dtm);




ALTER TABLE hkpmi.patient_history OWNER TO "HKPMI_SCHEMA_OWNER_ROLE";
