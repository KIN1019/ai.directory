-- DROP FUNCTION hkpmi.hkpmi_get_ehr_participant_cb(varchar, varchar, varchar, varchar);

CREATE OR REPLACE FUNCTION hkpmi.hkpmi_get_ehr_participant_cb(par_patient_key character varying, par_hkid character varying, par_source_system character varying, par_source_function character varying DEFAULT NULL::character varying)
    ...
    BEGIN
        ...
        IF par_source_system IN ('CMS', 'PMS', 'CDR', 'RIS', 'ePR', 'MCAF', 'eSHR', 'LIS', 'MOE') THEN
            BEGIN
                ...
                SELECT
                    TO_CHAR(timestamp_convert(localtimestamp), 'DD-Mon-YYYY')
                ...
                ELSE
                    IF var_travel_indicator = 'N' THEN
                        BEGIN
                            ...
                            SELECT
                                TO_CHAR(timestamp_convert(localtimestamp), 'DD-MM-YYYY HH24:mi:ss')
                                        ...
                                        IF "var_travelDateDiff" <= 30 THEN
                                            BEGIN
                                                ...
                                                SELECT
                                                    ...
                                                    INTO "var_iconColor";
                                                SELECT
                                                    CONCAT('Source: Immigration Department (as of ', TO_CHAR(localtimestamp, 'DD-Mon-YYYY'), ')')
                                                    INTO "var_travelMessage2";
                                            END;
                                        END IF;
                                    END;
                                    ...
                                    BEGIN
                                        ...
                                        IF "var_travelDateDiff" <= 30 THEN
                                            BEGIN
                                                ...
                                                END IF;
                                                SELECT
                                                    CONCAT('Source: Immigration Department (as of ', TO_CHAR(timestamp_convert(localtimestamp), 'DD-Mon-YYYY'), ')')
                                                    INTO "var_travelMessage2";
...
ALTER FUNCTION "hkpmi_get_ehr_participant_cb" OWNER TO "HKPMI_SCHEMA_OWNER_ROLE";
