        ...
        BEGIN
            ...
            SELECT
                ...
                CASE SUBSTRING(n.building, 1, 6)
                    ...
                    ELSE 0
                END, n.priority
                FROM t$temp_patient_key_list AS l, nok AS n
                WHERE l.patient_key = n.patient_key;
            /* --nok */
            OPEN p_refcur FOR
            SELECT
                RTRIM(n.patient_key) AS patient_key, n.priority AS nok_priority, n.major_nok AS nok_major_nok, RTRIM(n.hkid) AS nok_hkid, n.relationship AS nok_relationship, nr.description AS nok_description, RTRIM(n.nok_name) AS nok_name, n.home_phone AS nok_home_phone, n.office_phone AS nok_office_phone, n.office_phone_ext AS nok_office_phone_ext, n.other_phone AS nok_other_phone, n.other_phone_ext AS nok_other_phone_ext, n.room AS nok_room, n.floor AS nok_floor, n.block AS nok_block, l.nok_record_id, e.eh_name AS nok_eng_eh, e.eh_chinese_name AS nok_chi_eh,
                ...
                LEFT OUTER JOIN address_detail AS a
                    ON (l.nok_record_id = a.record_id), nok AS n
...
ALTER FUNCTION "pass_hkpmi_get_patients_nok" OWNER TO "HKPMI_SCHEMA_OWNER_ROLE";
