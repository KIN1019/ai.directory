-- DROP FUNCTION hkpmi."fn_tD_me_mail_record"();

CREATE OR REPLACE FUNCTION hkpmi."fn_tD_me_mail_record"()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
/* ---20140821 -- */
...
ALTER FUNCTION "fn_tD_me_mail_record" OWNER TO "HKPMI_SCHEMA_OWNER_ROLE";
