-- DROP PROCEDURE hkpmi.hkpmi_get_body_info_v2(inout int4, in bpchar, in bpchar, inout bpchar, inout bpchar, inout bpchar, inout bpchar, inout bpchar, inout bpchar, inout bpchar, inout bpchar, inout bpchar, inout bpchar, inout timestamp, inout bpchar, inout timestamp, inout bpchar, inout int4, inout varchar);

CREATE OR REPLACE PROCEDURE hkpmi.hkpmi_get_body_info_v2(INOUT pas_return_code integer, IN par_hospital_code VARCHAR, IN par_case_no VARCHAR, 
INOUT par_hkid VARCHAR, INOUT par_lof_hkid VARCHAR, INOUT par_patient_name VARCHAR, INOUT par_sex VARCHAR,
 INOUT par_cccode1 VARCHAR, INOUT par_cccode2 VARCHAR, INOUT par_cccode3 VARCHAR, INOUT par_cccode4 VARCHAR, 
 INOUT par_cccode5 VARCHAR, INOUT par_cccode6 VARCHAR, INOUT par_dob timestamp without time zone, INOUT par_exact_dob_flag VARCHAR, 
 INOUT par_death_date timestamp without time zone, INOUT par_body_category VARCHAR, INOUT par_retcode integer, INOUT par_error_msg character varying)
 LANGUAGE plpgsql
AS $procedure$
DECLARE
                ...
                BEGIN
                    ...
                    */
                    ...
                    SELECT
                        ...
                        /* ---and action_type='A' */
                        ORDER BY issue_datetime DESC NULLS LAST 
                        LIMIT 1;
                    /*
