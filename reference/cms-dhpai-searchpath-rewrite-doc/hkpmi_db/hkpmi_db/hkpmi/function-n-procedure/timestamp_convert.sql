-- DROP FUNCTION hkpmi.timestamp_convert(timestamp);

CREATE OR REPLACE FUNCTION hkpmi.timestamp_convert(par_timestamp timestamp without time zone)
...
ALTER FUNCTION "timestamp_convert" OWNER TO "HKPMI_SCHEMA_OWNER_ROLE";
