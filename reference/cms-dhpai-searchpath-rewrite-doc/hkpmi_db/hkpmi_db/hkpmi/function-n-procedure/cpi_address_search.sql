-- DROP FUNCTION hkpmi.cpi_address_search(varchar, varchar, varchar, varchar, varchar);

CREATE OR REPLACE FUNCTION hkpmi.cpi_address_search(par_region character varying, par_street_in character varying, par_build_land_in character varying, par_location_in character varying, par_location_all character varying)
...
ALTER FUNCTION "cpi_address_search" OWNER TO "HKPMI_SCHEMA_OWNER_ROLE";