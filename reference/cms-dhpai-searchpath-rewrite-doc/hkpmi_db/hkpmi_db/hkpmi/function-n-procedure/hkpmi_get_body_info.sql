-- DROP PROCEDURE hkpmi.hkpmi_get_body_info(inout int4, in bpchar, in bpchar, inout bpchar, inout bpchar, inout bpchar, inout bpchar, inout bpchar, inout bpchar, inout bpchar, inout bpchar, inout bpchar, inout timestamp, inout bpchar, inout timestamp, inout bpchar, inout int4, inout varchar);

CREATE OR REPLACE PROCEDURE hkpmi.hkpmi_get_body_info(INOUT pas_return_code integer, IN par_hospital_code VARCHAR, IN par_case_no VARCHAR, INOUT par_hkid VARCHAR, 
