...
begin
    ...
    BEGIN
        ...
        IF LTRIM(RTRIM(par_hosp_code)) = '' OR LTRIM(RTRIM(par_hosp_code)) = NULL THEN
            SELECT
                NULL
                INTO par_hosp_code;
        END IF;

        IF LTRIM(RTRIM(par_uid_hkid)) = '' OR LTRIM(RTRIM(par_uid_hkid)) = NULL THEN
            SELECT
                NULL
                INTO par_uid_hkid;
        END IF;

        IF LTRIM(RTRIM(par_link_hkid)) = '' OR LTRIM(RTRIM(par_link_hkid)) = NULL THEN
            SELECT
                NULL
                INTO par_link_hkid;
        END IF;

        IF LTRIM(RTRIM(par_link_status)) = '' OR LTRIM(RTRIM(par_link_status)) = NULL THEN
            SELECT
                NULL
		...
		IF par_create_dtm = NULL THEN
            SELECT
                NULL
                INTO par_create_dtm;
        END IF;

        IF LTRIM(RTRIM(par_create_hospital)) = '' OR LTRIM(RTRIM(par_create_hospital)) = NULL THEN
            SELECT
                NULL
                INTO par_create_hospital;
        END IF;

        IF LTRIM(RTRIM(par_create_user)) = '' OR LTRIM(RTRIM(par_create_user)) = NULL THEN
            SELECT
                NULL
                INTO par_create_user;
        END IF;

        IF LTRIM(RTRIM(par_create_system)) = '' OR LTRIM(RTRIM(par_create_system)) = NULL THEN
            SELECT
                NULL
		...
		IF par_update_dtm = NULL THEN
            SELECT
                NULL
                INTO par_update_dtm;
        END IF;

        IF LTRIM(RTRIM(par_update_hospital)) = '' OR LTRIM(RTRIM(par_update_hospital)) = NULL THEN
            SELECT
                NULL
                INTO par_update_hospital;
        END IF;

        IF LTRIM(RTRIM(par_update_user)) = '' OR LTRIM(RTRIM(par_update_user)) = NULL THEN
            SELECT
                NULL
                INTO par_update_user;
        END IF;

        IF LTRIM(RTRIM(par_update_system)) = '' OR LTRIM(RTRIM(par_update_system)) = NULL THEN
            SELECT
                NULL
