-- ehr_patient_list definition

-- Drop table

-- DROP FOREIGN TABLE ehr_patient_list;

CREATE FOREIGN TABLE ehr_patient_list (
...
OPTIONS (schema_name 'hkpmi', table_name 'ehr_patient_list');

ALTER TABLE ehr_patient_list OWNER TO "HKPMI_SCHEMA_OWNER_ROLE";
