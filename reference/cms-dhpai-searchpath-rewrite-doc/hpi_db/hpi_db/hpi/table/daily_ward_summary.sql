-- daily_ward_summary definition

-- Drop table

-- DROP TABLE daily_ward_summary;

CREATE TABLE daily_ward_summary (
...
CREATE UNIQUE INDEX daily_ward_summary_index ON daily_ward_summary USING btree (hospital_code, report_date, ward_code);




ALTER TABLE daily_ward_summary OWNER TO "HPI_SCHEMA_OWNER_ROLE";
