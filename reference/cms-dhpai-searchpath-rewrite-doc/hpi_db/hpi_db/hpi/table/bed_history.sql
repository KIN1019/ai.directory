...
CREATE UNIQUE INDEX bed_history_index ON bed_history USING btree (bed_no, hospital_code, ward_code, cubicle_no, effective_datetime);
CREATE INDEX bed_history_index2 ON bed_history USING btree (hospital_code, ward_code);




ALTER TABLE bed_history OWNER TO "HPI_SCHEMA_OWNER_ROLE";
