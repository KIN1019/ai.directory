-- DROP FUNCTION hpi.opas_cpi_discharge(varchar, varchar, varchar, varchar, timestamp, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, timestamp, varchar, varchar, varchar);

CREATE OR REPLACE FUNCTION opas_cpi_discharge(par_hospital_code character varying, par_case_no character varying, par_hkid character varying, par_discharge_code character varying, par_discharge_datetime timestamp without time zone, par_destination_code character varying, par_ward_code character varying, par_ward_class character varying, par_bed_no character varying, par_specialty_code character varying, par_sub_specialty character varying, par_doctor_code character varying, par_case_type character varying, par_txn_type character varying, par_transaction_datetime timestamp without time zone, par_update_by character varying, par_source_system character varying, par_mrt_indicator character varying DEFAULT ''::character varying)
...
;ALTER FUNCTION "opas_cpi_discharge" OWNER TO "HPI_SCHEMA_OWNER_ROLE";