-- DROP PROCEDURE hpi.cpi_address_phonetic_word(inout int4, in varchar, inout varchar);

CREATE OR REPLACE PROCEDURE hpi.cpi_address_phonetic_word(INOUT pas_return_code integer, IN par_string character varying, INOUT par_output character varying)
 LANGUAGE plpgsql
AS $procedure$
DECLARE
...
;ALTER PROCEDURE "cpi_address_phonetic_word" OWNER TO "HPI_SCHEMA_OWNER_ROLE";
