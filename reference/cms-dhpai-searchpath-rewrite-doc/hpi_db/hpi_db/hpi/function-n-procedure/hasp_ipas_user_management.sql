...
BEGIN
    ...
    BEGIN
        ...
        if @@trancount = 0
            ...
            begin
        		select @begin_tran = 'S'
        		save transaction hasp_ipas_user_management
            end
        */
        /* -------------- */
