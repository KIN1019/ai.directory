-- DROP PROCEDURE hpi.cpi_pq_validate_mrn(inout int4, in varchar, in varchar, inout varchar);

CREATE OR REPLACE PROCEDURE hpi.cpi_pq_validate_mrn(INOUT pas_return_code integer, IN par_mrn character varying, IN par_hospital_code character varying, INOUT par_valid_flag character varying)
 LANGUAGE plpgsql
AS $procedure$
/*
...
;ALTER PROCEDURE "cpi_pq_validate_mrn" OWNER TO "HPI_SCHEMA_OWNER_ROLE";
