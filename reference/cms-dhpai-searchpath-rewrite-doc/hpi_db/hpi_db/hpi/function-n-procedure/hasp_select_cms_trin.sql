-- DROP FUNCTION hpi.hasp_select_cms_trin(varchar, timestamp, timestamp, varchar);

CREATE OR REPLACE FUNCTION hpi.hasp_select_cms_trin(par_hosp_code character varying, par_trans_sys_fdatetime timestamp without time zone, par_trans_sys_tdatetime timestamp without time zone, par_trans_ns_code character varying)
...
;ALTER FUNCTION "hasp_select_cms_trin" OWNER TO "HPI_SCHEMA_OWNER_ROLE";
