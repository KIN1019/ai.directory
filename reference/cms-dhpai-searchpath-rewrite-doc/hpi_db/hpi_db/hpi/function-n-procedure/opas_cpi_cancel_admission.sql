-- DROP FUNCTION hpi.opas_cpi_cancel_admission(varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, timestamp, varchar, varchar);

CREATE OR REPLACE FUNCTION hpi.opas_cpi_cancel_admission(par_hospital_code character varying, par_case_no character varying, par_hkid character varying, par_ward_code character varying, par_ward_class character varying, par_bed_no character varying, par_specialty_code character varying, par_sub_specialty character varying, par_case_type character varying, par_txn_type character varying, par_transaction_datetime timestamp without time zone, par_update_by character varying, par_source_system character varying)
...
BEGIN
    ...
    CALL cpi_cancel_admission(var_return_code, par_hospital_code, par_case_no, par_hkid, par_ward_code, par_ward_class, par_bed_no, par_specialty_code, par_sub_specialty, par_case_type, par_txn_type, par_transaction_datetime, par_update_by, par_source_system);
...
;ALTER FUNCTION "opas_cpi_cancel_admission" OWNER TO "HPI_SCHEMA_OWNER_ROLE";