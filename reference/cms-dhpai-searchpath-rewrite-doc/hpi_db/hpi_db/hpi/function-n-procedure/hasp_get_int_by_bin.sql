-- DROP PROCEDURE hpi.hasp_get_int_by_bin(inout int4, in varchar, inout int4);

CREATE OR REPLACE PROCEDURE hpi.hasp_get_int_by_bin(INOUT pas_return_code integer, IN par_on_off_bit character varying, INOUT par_hex_int integer)
 LANGUAGE plpgsql
AS $procedure$
/*
...
;ALTER PROCEDURE "hasp_get_int_by_bin" OWNER TO "HPI_SCHEMA_OWNER_ROLE";
