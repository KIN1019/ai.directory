...
- Provides a **secure, controlled bridge** between AI assistants and HA systemsdata.
- Ensures that only **authorised requests** are processed, following hospital security protocols.
